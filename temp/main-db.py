    ...
    if idcheck_one:
        if idcheck_two:
            try:
                ...
                main_msg = await ctx.send(
                    'Data for ' + display_name_one + ' is loading... You will be pinged when the embed is sent!')
                # Check presence of streamer in cache
                if username_one in cached_results:
                    ...
                    await store_user_in_database(cached_results[username_one])
                ...
                if username_two in cached_results:
                    ...
                    await store_user_in_database(cached_results[username_two])
